 ...
 * VendasImeiAtual
 *
 * @ORM\Table(name="vendas_imei_atual", uniqueConstraints={@ORM\UniqueConstraint(name="id_imei_UNIQUE", columns={"id_imei", "data_emissao", "id_matriz"}), @ORM\UniqueConstraint(name="unico", columns={"imei", "codigo_part_number_produto", "numero_nota_fiscal", "data_emissao", "cnpj_distribuidor_filial", "cnpj_cpf", "tipo_movimento", "id_matriz"})}, indexes={@ORM\Index(name="id_matriz_nota_fiscal_INDEX", columns={"numero_nota_fiscal", "data_emissao", "codigo_part_number_produto", "id_matriz", "tipo_movimento", "imei"}), @ORM\Index(name="GI", columns={"id_matriz", "data_emissao", "tipo_movimento"})})
 * @ORM\Entity
 */
class VendasImeiAtual
{
    /**
     * @var integer
     *
