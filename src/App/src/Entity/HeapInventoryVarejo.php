 ...
 * HeapInventoryVarejo
 *
 * @ORM\Table(name="heap_inventory_varejo", uniqueConstraints={@ORM\UniqueConstraint(name="Chaves", columns={"EANCode", "SECModelCode", "PartnerCode"})})
 * @ORM\Entity
 */
class HeapInventoryVarejo
{
    /**
     * @var integer
     *
