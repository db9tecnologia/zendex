 ...
 * TransferenciasBase
 *
 * @ORM\Table(name="transferencias_base", uniqueConstraints={@ORM\UniqueConstraint(name="colunas", columns={"numero_nota_fiscal", "codigo_part_number_produto", "id_matriz", "tipo_movimento", "valor_unitario", "cnpj_distribuidor_filial"})}, indexes={@ORM\Index(name="idx_vendas_id_matriz_atualizado_em", columns={"id_matriz", "atualizado_em"})})
 * @ORM\Entity
 */
class TransferenciasBase
{
    /**
     * @var integer
     *
