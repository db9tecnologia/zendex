...
/**
 * TransferenciasBackup
 *
 * @ORM\Table(name="transferencias_backup", indexes={@ORM\Index(name="idx_vendas_id_matriz_atualizado_em", columns={"id_matriz", "atualizado_em"})})
 * @ORM\Entity
 */
class TransferenciasBackup
{
    /**
     * @var integer
     *
