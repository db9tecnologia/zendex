 ...
 * VendasImei
 *
 * @ORM\Table(name="vendas_imei", uniqueConstraints={@ORM\UniqueConstraint(name="id_imei_UNIQUE", columns={"id_imei", "data_emissao", "id_matriz"}), @ORM\UniqueConstraint(name="updatedk", columns={"imei", "numero_nota_fiscal", "codigo_part_number_produto", "tipo_movimento", "data_emissao", "cnpj_distribuidor_filial", "id_matriz", "cnpj_cpf"})}, indexes={@ORM\Index(name="id_matriz_nota_fiscal_INDEX", columns={"numero_nota_fiscal", "data_emissao", "codigo_part_number_produto", "id_matriz", "tipo_movimento", "imei"}), @ORM\Index(name="GI", columns={"id_matriz", "data_emissao", "tipo_movimento"})})
 * @ORM\Entity
 */
class VendasImei
{
